...
architecture: amd64                                 # 部署集群的机器架构
platform: libvirt                                   # 部署平台为libvirt
infraplatform
  uri: qemu:///system                                
  osimage:                                          # 指定部署集群机器的操作系统镜像地址
...
housekeeper:                                                                                          # housekeeper相关配置列表
  ...
  operatorimageurl: "hub.oepkgs.net/nestos/housekeeper/{arch}/housekeeper-operator-manager:{tag}"     # housekeeper-operator镜像的地址
  controllerimageurl: "hub.oepkgs.net/nestos/housekeeper/{arch}/housekeeper-controller-manager:{tag}" # housekeeper-controller镜像的地址   
