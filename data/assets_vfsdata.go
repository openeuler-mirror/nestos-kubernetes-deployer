...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/bootconfig/files/etc/isulad/daemon.json.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 5, 20, 7, 50, 39, 786495422, time.UTC),
		...
		"/bootconfig/files/etc/nkdfiles": &vfsgen۰DirInfo{
			name:    "nkdfiles",
			modTime: time.Date(2024, 5, 21, 7, 18, 39, 766578961, time.UTC),
		},
		...
		"/bootconfig/files/etc/nkdfiles/node-pivot.sh.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 5, 21, 8, 5, 37, 344378807, time.UTC),
			uncompressedSize: 6299,
		...
		"/bootconfig/systemd": &vfsgen۰DirInfo{
			name:    "systemd",
			modTime: time.Date(2024, 5, 21, 3, 29, 2, 704644906, time.UTC),
		},
