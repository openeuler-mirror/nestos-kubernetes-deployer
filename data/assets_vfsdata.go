...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/ignition/master/systemd/join-master.service.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 2, 27, 3, 36, 53, 520162740, time.UTC),
		...
		"/ignition/worker/files/etc/nkd": &vfsgen۰DirInfo{
			name:    "nkd",
			modTime: time.Date(2024, 2, 26, 7, 32, 34, 130313269, time.UTC),
		},
