...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2024, 4, 16, 1, 29, 12, 475173481, time.UTC),
		},
		"/bootconfig": &vfsgen۰DirInfo{
			name:    "bootconfig",
			modTime: time.Date(2024, 4, 17, 8, 40, 18, 781717518, time.UTC),
		},
		"/bootconfig/files": &vfsgen۰DirInfo{
			name:    "files",
			modTime: time.Date(2024, 4, 16, 7, 13, 49, 490544687, time.UTC),
		},
		"/bootconfig/files/etc": &vfsgen۰DirInfo{
			name:    "etc",
			modTime: time.Date(2024, 4, 16, 6, 57, 42, 552993587, time.UTC),
		},
		"/bootconfig/files/etc/hosts.template": &vfsgen۰CompressedFileInfo{
			name:             "hosts.template",
			modTime:          time.Date(2024, 4, 12, 8, 42, 56, 294356356, time.UTC),
		...
		"/bootconfig/systemd": &vfsgen۰DirInfo{
			name:    "systemd",
			modTime: time.Date(2024, 4, 16, 6, 55, 39, 455851470, time.UTC),
		},
		"/bootconfig/systemd/init-cluster.service": &vfsgen۰CompressedFileInfo{
			name:             "init-cluster.service",
			modTime:          time.Date(2024, 4, 17, 5, 58, 39, 257289495, time.UTC),
		...
		"/bootconfig/systemd/join-master.service.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 4, 12, 8, 42, 56, 298356263, time.UTC),
		...
		"/bootconfig/systemd/release-image-pivot.service": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 4, 17, 2, 18, 32, 914733188, time.UTC),
