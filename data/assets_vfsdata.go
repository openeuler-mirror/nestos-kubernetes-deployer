...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/ignition/controlplane/files/etc/nkd/init-config.yaml.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 2, 23, 7, 10, 51, 387036854, time.UTC),
