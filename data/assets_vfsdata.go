...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2024, 5, 23, 9, 3, 39, 206082831, time.UTC),
		},
		...
		"/bootconfig/kickstart.cfg.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 5, 24, 7, 36, 28, 756422545, time.UTC),
