...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2024, 6, 27, 6, 35, 43, 413649079, time.UTC),
		},
		...
		"/bootconfig/files": &vfsgen۰DirInfo{
			name:    "files",
			modTime: time.Date(2024, 6, 27, 6, 35, 43, 412649065, time.UTC),
		},
		...
		"/terraform": &vfsgen۰DirInfo{
			name:    "terraform",
			modTime: time.Date(2024, 6, 27, 6, 35, 43, 414649093, time.UTC),
		},
		...
		"/terraform/aarch64/generalos/libvirt/master.tf.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 6, 27, 9, 6, 17, 691384190, time.UTC),
		...
		"/terraform/aarch64/generalos/libvirt/worker.tf.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 6, 27, 9, 6, 55, 133901643, time.UTC),
