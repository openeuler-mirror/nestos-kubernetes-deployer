...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2024, 5, 16, 1, 0, 55, 322036308, time.UTC),
		},
		...
		"/bootconfig/files": &vfsgen۰DirInfo{
			name:    "files",
			modTime: time.Date(2024, 5, 16, 1, 0, 55, 321036328, time.UTC),
		},
		...
		"/bootconfig/files/etc/isulad": &vfsgen۰DirInfo{
			name:    "isulad",
			modTime: time.Date(2024, 5, 22, 2, 43, 44, 612550465, time.UTC),
		},
		...
		"/terraform/generalos/libvirt/master.tf.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 5, 21, 1, 34, 34, 879652527, time.UTC),
		...
		"/terraform/generalos/libvirt/worker.tf.template": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 5, 21, 1, 34, 48, 870839785, time.UTC),
		...
		"/terraform/generalos/openstack": &vfsgen۰DirInfo{
			name:    "openstack",
			modTime: time.Date(2024, 5, 17, 8, 16, 33, 496540174, time.UTC),
		},
		"/terraform/generalos/openstack/master.tf.template": &vfsgen۰CompressedFileInfo{
			name:             "master.tf.template",
			modTime:          time.Date(2024, 5, 21, 1, 30, 33, 652460138, time.UTC),
		...
		"/terraform/generalos/openstack/worker.tf.template": &vfsgen۰CompressedFileInfo{
			name:             "worker.tf.template",
			modTime:          time.Date(2024, 5, 21, 1, 33, 12, 230546350, time.UTC),
		...
		"/terraform/nestos/libvirt/master.tf.template": &vfsgen۰CompressedFileInfo{
			name:             "master.tf.template",
			modTime:          time.Date(2024, 5, 21, 1, 34, 59, 289979233, time.UTC),
		...
		"/terraform/nestos/libvirt/worker.tf.template": &vfsgen۰CompressedFileInfo{
			name:             "worker.tf.template",
			modTime:          time.Date(2024, 5, 21, 1, 35, 7, 503089157, time.UTC),
		...
		"/terraform/nestos/openstack/master.tf.template": &vfsgen۰CompressedFileInfo{
			name:             "master.tf.template",
			modTime:          time.Date(2024, 5, 21, 1, 32, 20, 949861195, time.UTC),
			uncompressedSize: 4739,
		...
		"/terraform/nestos/openstack/worker.tf.template": &vfsgen۰CompressedFileInfo{
			name:             "worker.tf.template",
			modTime:          time.Date(2024, 5, 21, 1, 33, 46, 760008493, time.UTC),
			uncompressedSize: 4720,
